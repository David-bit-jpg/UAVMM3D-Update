...
# MAV6D 专用的中心点编解码器。上面那对 center_point_* 对 (N, 10) 的二维 gt 会
# IndexError，且反投影里带了 CARLA 的坐标轴置换，对 MAV6D 不成立。
# 这里额外注册一对独立实现，不影响原有条目的行为。
from uavdet3d.utils.object_encoder_mav6d import (  # noqa: E402
    center_point_encoder as center_point_encoder_mav6d,
    center_point_decoder as center_point_decoder_mav6d,
)
